...
proc do_something {agents_ nodes_ god_} {
	...
	$ns_ at 5.0 "$node_(6) setdest 1.0 1.0 5.0"
	$ns_ at 5.0 "$node_(7) setdest 1.0 2.0 5.0"
	
	$ns_ at 5.0 "$node_(6) setdest 1.0 2.0 5.0"
	$ns_ at 5.0 "$node_(7) setdest 1.0 3.0 5.0"
}
