...
class MulticastOverhead(GenericMeasure):
	def __init__(self, period, simulationTime):		
		...
		self.__measures.append(SentTableMessages(period, simulationTime))
		self.__measures.append(SentSearchMessages(period, simulationTime))
		self.__measures.append(SentSearchResponseMessages(period, simulationTime))
		self.__measures.append(SentRemoveRouteMessages(period, simulationTime))
		self.__measures.append(SentRemoveParametersMessages(period, simulationTime))
